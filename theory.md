...
<embed src="https://aky4wn.github.io/Classical-Music-Composition-Using-Hidden-Markov-Models/theory/images/treble_clef.pdf" width="50" height="75" type='application/pdf'>

<embed src="https://aky4wn.github.io/Classical-Music-Composition-Using-Hidden-Markov-Models/theory/images/bass_clef.pdf" width="50" height="75" type='application/pdf'>

{% include image.html url="/images/treble_clef.png" caption="Treble Clef" width=30 align="left" %}
...
- [Perfect Unison]({{ site.url }}/music_theory/unison.mp3) {% include image.html url="/images/unison.pdf" caption="Perfect Unison Interval" width=300 align="right" %}
- [Minor Second]({{ site.url }}/music_theory/a_minor2nd.mp3) {% include image.html url="/images/a_minor2nd.pdf" caption="Minor Second Ascending Interval" width=300 align="right" %}
- [Major Second]({{ site.url }}/music_theory/a_major2nd.mp3){% include image.html url="/images/a_major2nd.pdf" caption="Major Second Ascending Interval" width=300 align="right" %}
- [Minor Third]({{ site.url }}/music_theory/a_minor3rd.mp3){% include image.html url="/images/a_minor3rd.pdf" caption="Minor Third Ascending Interval" width=300 align="right" %}
- [Major Third]({{ site.url }}/music_theory/a_major3rd.mp3) {% include image.html url="/images/a_major3rd.pdf" caption="Major Third Ascending Interval" width=300 align="right" %}
- [Perfect Fourth]({{ site.url }}/music_theory/a_perfect4th.mp3) {% include image.html url="/images/a_perfect4th.pdf" caption="Perfect Fourth Ascending Interval" width=300 align="right" %}
- [Tritone]({{ site.url }}/music_theory/a_tritone.mp3) {% include image.html url="/images/a_tritone.pdf" caption="Triton Ascending Interval" width=300 align="right" %}
- [Perfect Fifth]({{ site.url }}/music_theory/a_perfect5th.mp3) {% include image.html url="/images/a_perfect5th.pdf" caption="Perfect Fifth Ascending Interval" width=300 align="right" %}
- [Minor Sixth]({{ site.url }}/music_theory/a_minor6th.mp3) {% include image.html url="/images/a_minor6th.pdf" caption="Minor Sixth Ascending Interval" width=300 align="right" %}
- [Major Sixth]({{ site.url }}/music_theory/a_major6th.mp3) {% include image.html url="/images/a_major6th.pdf" caption="Major Sixth Ascending Interval" width=300 align="right" %}
- [Minor Seventh]({{ site.url }}/music_theory/a_minor7th.mp3) {% include image.html url="/images/a_minor7th.pdf" caption="Minor Seventh Ascending Interval" width=300 align="right" %}
- [Major Seventh]({{ site.url }}/music_theory/a_major7th.mp3) {% include image.html url="/images/a_major7th.pdf" caption="Major Seventh Ascending Interval" width=300 align="right" %}
- [Perfect Octave]({{ site.url }}/music_theory/a_octave.mp3) {% include image.html url="/images/a_octave.pdf" caption="Perfect Octave Ascending Interval" width=300 align="right" %}
...
- [Major Second]({{ site.url }}/music_theory/d_major2nd.mp3){% include image.html url="/images/d_major2nd.pdf" caption="Major Second Descending Interval" width=300 align="right" %}
- [Minor Third]({{ site.url }}/music_theory/d_minor3rd.mp3){% include image.html url="/images/d_minor3rd.pdf" caption="Minor Third Descending Interval" width=300 align="right" %}
- [Major Third]({{ site.url }}/music_theory/d_major3rd.mp3) {% include image.html url="/images/d_major3rd.pdf" caption="Major Third Descending Interval" width=300 align="right" %}
- [Perfect Fourth]({{ site.url }}/music_theory/d_perfect4th.mp3) {% include image.html url="/images/d_perfect4th.pdf" caption="Perfect Fourth Descending Interval" width=300 align="right" %}
- [Tritone]({{ site.url }}/music_theory/d_tritone.mp3) {% include image.html url="/images/d_tritone.pdf" caption="Triton Descending Interval" width=300 align="right" %}
- [Perfect Fifth]({{ site.url }}/music_theory/d_perfect5th.mp3) {% include image.html url="/images/d_perfect5th.pdf" caption="Perfect Fifth Descending Interval" width=300 align="right" %}
- [Minor Sixth]({{ site.url }}/music_theory/d_minor6th.mp3) {% include image.html url="/images/d_minor6th.pdf" caption="Minor Sixth Descending Interval" width=300 align="right" %}
- [Major Sixth]({{ site.url }}/music_theory/d_major6th.mp3) {% include image.html url="/images/d_major6th.pdf" caption="Major Sixth Descending Interval" width=300 align="right" %}
- [Minor Seventh]({{ site.url }}/music_theory/d_minor7th.mp3) {% include image.html url="/images/d_minor7th.pdf" caption="Minor Seventh Descending Interval" width=300 align="right" %}
- [Major Seventh]({{ site.url }}/music_theory/d_major7th.mp3) {% include image.html url="/images/d_major7th.pdf" caption="Major Seventh Descending Interval" width=300 align="right" %}
- [Perfect Octave]({{ site.url }}/music_theory/d_octave.mp3) {% include image.html url="/images/d_octave.pdf" caption="Perfect Octave Descending Interval" width=300 align="right" %}
...
- [Major Triad]({{ site.url }}/music_theory/major_triad.mp3) {% include image.html url="/images/major_triad.pdf" caption="C-Major scale of major triads" width=300 align="right" %}
- [Minor Triad]({{ site.url }}/music_theory/minor_triad.mp3) {% include image.html url="/images/minor_triad.pdf" caption="C-Major scale of minor triads" width=300 align="right" %}
- [Major Triad]({{ site.url }}/music_theory/major_7th_chords.mp3) {% include image.html url="/images/major_7th_chords.pdf" caption="C-Major scale of major seventh chords" width=300 align="right" %}
...
[Perfect Consonances]({{ site.url }}/music_theory/open_chords.mp3) {% include image.html url="/images/open_chords.pdf" caption="Perfect fourth, perfect fifth and perfect octave harmonic intervals in C-Major" width=300 align="right" %}
...
[Mussorgsky - Pictures at an Exhibition, Gnomus]({{ site.url }}/music_theory/muss_motif.mp3) {% include image.html url="/images/muss_motif.pdf" caption="Opening motif of Mussorgsky's Pictures at an Exhibition - Gnomus" width=300 align="right" %}
